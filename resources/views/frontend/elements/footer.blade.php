<footer>
@php
    $featured_products = \App\Models\Product::active()->where('featured', 1)->take(3)->inRandomOrder()->get();
    $onsale_products = \App\Models\Product::active()->where('onsale', 1)->take(3)->inRandomOrder()->get();
    $top_rated_products = \App\Models\Product::active()->where('top_rated', 1)->take(3)->inRandomOrder()->get();
@endphp
<!-- Footer-top-widget -->
    <div class="container d-none d-lg-block mb-3">
        <div class="row">
            <div class="col-wd-3 col-lg-4">
                <div class="widget-column">
                    ...
                    <ul class="list-unstyled products-group">
                        @forelse($featured_products as $f_p)
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="{{ route('product.details', $f_p->slug) }}"
                                       class="d-block width-75 text-center">
                                        <img class="img-fluid"
                                             src="{{ $f_p->images()->where(['type' => 'thumbnail', 'size' => '75x75'])->first()->url ?? getDefaultImage() }}"
                                ...
                                <div class="col pl-4 d-flex flex-column">
                                    <h5 class="product-item__title mb-0">
                                        <a href="{{ route('product.details', $f_p->slug) }}"
                                           class="text-blue font-weight-bold">{{ $f_p->name }}</a>
                                    </h5>
                                    <div class="prodcut-price mt-auto">
                                        <div class="font-size-15">{{ getCurrencyIcon() }} {{ $f_p->price }}</div>
                                    </div>
                                </div>
                            </li>
                        @empty
            ...
            <div class="col-wd-3 col-lg-4">
                ...
                <ul class="list-unstyled products-group">
                    @forelse($onsale_products as $o_p)
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="{{ route('product.details', $o_p->slug) }}"
                                   class="d-block width-75 text-center">
                                    <img class="img-fluid"
                                         src="{{ $o_p->images()->where(['type' => 'thumbnail', 'size' => '75x75'])->first()->url ?? getDefaultImage() }}"
                                         alt="Image Description">
                                </a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
                                <h5 class="product-item__title mb-0">
                                    <a href="{{ route('product.details', $o_p->slug) }}"
                                       class="text-blue font-weight-bold">{{ $o_p->name }}</a>
                                </h5>
                                <div class="prodcut-price mt-auto">
                                    <div class="font-size-15">{{ getCurrencyIcon() }} {{ $o_p->price }}</div>
                                </div>
                            </div>
                        </li>
                    @empty
            ...
            <div class="col-wd-3 col-lg-4">
                ...
                <ul class="list-unstyled products-group">
                    @forelse($top_rated_products as $t_p)
                        <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                            <div class="col-auto">
                                <a href="{{ route('product.details', $t_p->slug) }}"
                                   class="d-block width-75 text-center">
                                    <img class="img-fluid"
                                         src="{{ $t_p->images()->where(['type' => 'thumbnail', 'size' => '75x75'])->first()->url ?? getDefaultImage() }}"
                                         alt="Image Description">
                                </a>
                            </div>
                            <div class="col pl-4 d-flex flex-column">
                                <h5 class="product-item__title mb-0">
                                    <a href="{{ route('product.details', $t_p->slug) }}"
                                       class="text-blue font-weight-bold">{{ $t_p->name }}</a>
                                </h5>
                                <div class="prodcut-price mt-auto">
                                    <div class="font-size-15">{{ getCurrencyIcon() }} {{ $t_p->price }}</div>
                                </div>
                            </div>
                        </li>
                    @empty
                ...
                <div class="col-lg-7">
                    <div class="row">
                        ...
                        <div class="col-12 col-md mb-4 mb-md-0">
                            ...
                            <!-- List Group -->
                            <ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
                                <li><a class="list-group-item list-group-item-action" href="/my-account">My
                                        Account</a></li>
                                <li><a class="list-group-item list-group-item-action"
                                       href="../shop/track-your-order.html">Order Tracking</a></li>
                                <li><a class="list-group-item list-group-item-action" href="/wishlist">Wish
                                        List</a></li>
                                <li><a class="list-group-item list-group-item-action"
                                       href="../home/terms-and-conditions.html">Customer Service</a></li>
                                <li><a class="list-group-item list-group-item-action"
                                       href="../home/terms-and-conditions.html">Returns / Exchange</a></li>
                                <li><a class="list-group-item list-group-item-action" href="/faq">FAQs</a>
                                </li>
                                <li><a class="list-group-item list-group-item-action"
