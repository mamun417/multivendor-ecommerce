                                                    ...
                                                    <li class="u-has-submenu u-header-collapse__submenu">
                                                        ...
                                                        <div id="headerSidebarHomeCollapse" class="collapse"
                                                            ...
                                                            <ul id="headerSidebarHomeMenu"
                                                                ...
                                                                <!-- Store Directory -->
                                                                <li><a class="u-header-collapse__submenu-nav-link"
                                                                       href="{{ url('store-directory') }}">Store
                                                                        Directory</a></li>
                                                                <!-- End Store Directory -->
                                                    ...
                                                    <li class="u-has-submenu u-header-collapse__submenu">
                                                        ...
                                                        <div id="headerSidebarPagesCollapse" class="collapse"
                                                            ...
                                                            <ul id="headerSidebarPagesMenu"
                                                                ...
                                                                <!-- Shop Grid -->
                                                                <li><a class="u-header-collapse__submenu-nav-link"
                                                                       href="{{ url('shop-grid') }}">Shop Grid</a></li>
                                                                <!-- End Shop Grid -->

                                                                <!-- Shop Grid Extended -->
                                                                <li><a class="u-header-collapse__submenu-nav-link"
                                                                       href="{{ url('shop-grid-extended') }}">Shop Grid
                                                                        Extended</a></li>
                                                                <!-- End Shop Grid Extended -->

                                                                <!-- Shop List View -->
                                                                <li><a class="u-header-collapse__submenu-nav-link"
                                                                       href="{{ url('shop-list-view') }}">Shop List
                                                                        View</a></li>
                                                                <!-- End Shop List View -->

                                                                <!-- Shop List View Small -->
                                                                <li><a class="u-header-collapse__submenu-nav-link"
                                                                       href="{{ url('shop-list-view-small') }}">Shop
                                                                        List View Small</a></li>
                                                                <!-- End Shop List View Small -->

                                                                <!-- Shop Left Sidebar -->
                                                                <li><a class="u-header-collapse__submenu-nav-link"
                                                                       href="{{ url('shop-left-sidebar') }}">Shop Left
                                                                        Sidebar</a></li>
                                                                <!-- End Shop Left Sidebar -->

                                                                <!-- Shop Full width -->
                                                                <li><a class="u-header-collapse__submenu-nav-link"
                                                                       href="{{ url('shop-full-width') }}">Shop Full
                                                                        width</a></li>
                                                                <!-- End Shop Full width -->

                                                                <!-- Shop Right Sidebar -->
                                                                <li><a class="u-header-collapse__submenu-nav-link"
                                                                       href="{{ url('shop-right-sidebar') }}">Shop Right
                                                                        Sidebar</a></li>
                                                    ...
                                                    <li class="u-has-submenu u-header-collapse__submenu">
                                                        ...
                                                        <div id="headerSidebarDemosCollapse" class="collapse"
                                                            ...
                                                            <ul id="headerSidebarDemosMenu"
                                                                ...
                                                                <!-- Track your Order -->
                                                                <li><a class="u-header-collapse__submenu-nav-link"
                                                                       href="/track-your-order">Track your
                                                                        Order</a></li>
                                ...
                                <ul class="navbar-nav u-header__navbar-nav">
                                    ...
                                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                                        ...
                                        <ul id="HomeSubMenu" class="hs-sub-menu u-header__sub-menu animated fadeOut"
                                            ...
                                            <li><a class="nav-link u-header__sub-menu-nav-link" href="index.html">Home
                                                    v1</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link" href="home-v2.html">Home
                                                    v2</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link" href="home-v3.html">Home
                                                    v3</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="home-v3-full-color-bg.html">Home v3.1</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link" href="home-v4.html">Home
                                                    v4</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link" href="home-v5.html">Home
                                                    v5</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link" href="home-v6.html">Home
                                                    v6</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link" href="home-v7.html">Home
                                                    v7</a></li>
                                        </ul>
                                        <!-- End Home - Submenu -->
                                    </li>
                                                    ...
                                                    <ul class="u-header__sub-menu-nav-group">
                                                        ...
                                                        <li><a href="../shop/product-categories-5-column-sidebar.html"
                                                               class="nav-link u-header__sub-menu-nav-link">5 Column
                                                                Sidebar</a></li>
                                                        <li>
                                                            <a href="../shop/product-categories-6-column-full-width.html"
                                    ...
                                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                                        ...
                                        <ul id="blogSubMenu" class="hs-sub-menu u-header__sub-menu"
                                            ...
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="../blog/blog-v3.html">Blog v3</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="../blog/blog-full-width.html">Blog Full Width</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="../blog/single-blog-post.html">Single Blog Post</a></li>
                                        </ul>
                                        <!-- End Submenu -->
                                    </li>
                                    <!-- End Blog -->
                                    ...
                                    <!-- FAQs -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="/faq">FAQs</a>
                                    </li>
                                    <!-- End FAQs -->

                                    <!-- Contact Us -->
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="/contact-v2">Contact Us</a>
                                    </li>
                                    <!-- End Contact Us -->
                                </ul>
                            </div>
                                                    ...
                                                    <ul class="navbar-nav u-header__navbar-nav border-primary border-top-0">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                ...
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img1.png') }}"
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                ...
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img4.png') }}"
                                                                         alt="Image Description">
                                                                </div>
                                                                <div class="row u-header__mega-menu-wrapper">
                                                                    <div class="col mb-3 mb-sm-0">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img3.png') }}"
                                                                         alt="Image Description">
                                                                </div>
                                                                <div class="row u-header__mega-menu-wrapper">
                                                                    <div class="col mb-3 mb-sm-0">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <a id="basicMegaMenu3"
                                                               class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                                               href="javascript:;" aria-haspopup="true"
                                                               aria-expanded="false">Movies, Music & Video</a>
                                                            ...
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                ...
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img2.png') }}"
                                                                         alt="Image Description">
                                                                </div>
                                                                <div class="row u-header__mega-menu-wrapper">
                                                                    <div class="col mb-3 mb-sm-0">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                ...
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img5.png') }}"
                                                                         alt="Image Description">
                                                                </div>
                                                                <div class="row u-header__mega-menu-wrapper">
                                                                    <div class="col mb-3 mb-sm-0">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                ...
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img6.png') }}"
                                                                         alt="Image Description">
                                                                </div>
                                                                <div class="row u-header__mega-menu-wrapper">
                                                                    <div class="col mb-3 mb-sm-0">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <!-- Nav Item - Mega Menu -->
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                 aria-labelledby="basicMegaMenu6">
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img1.png') }}"
                                                                         alt="Image Description">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <a id="basicMegaMenu7"
                                                               class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                                               href="javascript:;" aria-haspopup="true"
                                                               aria-expanded="false">Printers & Ink</a>

                                                            <!-- Nav Item - Mega Menu -->
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                 aria-labelledby="basicMegaMenu7">
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img1.png') }}"
                                                                         alt="Image Description">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <a id="basicMegaMenu8"
                                                               class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                                               href="javascript:;" aria-haspopup="true"
                                                               aria-expanded="false">Office Supplies</a>

                                                            <!-- Nav Item - Mega Menu -->
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                 aria-labelledby="basicMegaMenu8">
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img1.png') }}"
                                                                         alt="Image Description">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <a id="basicMegaMenu9"
                                                               class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                                               href="javascript:;" aria-haspopup="true"
                                                               aria-expanded="false">Computer Components</a>
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <a id="basicMegaMenu10"
                                                               class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                                               href="javascript:;" aria-haspopup="true"
                                                               aria-expanded="false">PC Gaming Headsets</a>

                                                            <!-- Nav Item - Mega Menu -->
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                 aria-labelledby="basicMegaMenu10">
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img1.png') }}"
                                                                         alt="Image Description">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            data-event="hover"
                                                            data-position="left">
                                                            <a id="basicMegaMenu11"
                                                               class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                                               href="javascript:;" aria-haspopup="true"
                                                               aria-expanded="false">Smart TVs</a>

                                                            <!-- Nav Item - Mega Menu -->
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                 aria-labelledby="basicMegaMenu11">
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img1.png') }}"
                                                                         alt="Image Description">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                            ...
                                                            <!-- Nav Item - Mega Menu -->
                                                            <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                                 aria-labelledby="basicMegaMenu12">
                                                                <div class="vmm-bg">
                                                                    <img class="img-fluid"
                                                                         src="{{ asset('frontend/assets/img/500X400/img1.png') }}"
                                                                         alt="Image Description">
                    ...
                    <div class="col-md-auto align-self-center">
                        <div class="d-flex">
                            <ul class="d-flex list-unstyled mb-0">
                                <li class="col"><a href="/compare" class="text-gray-90"
                                                   data-toggle="tooltip" data-placement="top" title="Compare"><i
                                            class="font-size-22 ec ec-compare"></i></a></li>
                                <li class="col"><a href="/wishlist" class="text-gray-90"
