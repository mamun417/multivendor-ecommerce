                                    ...
                                    <div class="border rounded-pill py-1 width-122 w-xl-80 px-3 border-color-1">
                                        <div class="js-quantity row align-items-center">
                                            ...
                                            <div class="col-auto pr-1">
                                                <a onclick="minusQty()" class="js-minus btn btn-icon btn-xs btn-outline-secondary rounded-circle border-0"
                                                   href="javascript:">
                                                    <small class="fas fa-minus btn-icon__inner"></small>
                                                </a>
                                                <a onclick="plusQty()" class="js-plus btn btn-icon btn-xs btn-outline-secondary rounded-circle border-0"
                                                   href="javascript:">
