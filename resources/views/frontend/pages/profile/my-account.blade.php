                ...
                <div class="card shadow mt-3">
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <button id="updateInfoBtnForUser" type="submit"
                                            class="btn btn-warning py-1 px-4">Update
                                    </button>
                                </div>
                            </div>
                        </form>
                        ...
                        <h5 class="h5 m-0">Password <small class="ml-4"><a href="javascript:void(0)"
                                                                           class="text-info edit_pass">Edit</a></small>
                        </h5>
                        <hr class="my-4">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <button type="submit" id="passUpdateInfoBtnForUser"
                                            class="btn btn-warning py-1 px-4">Save
                                    </button>
                                </div>
                            </div>
