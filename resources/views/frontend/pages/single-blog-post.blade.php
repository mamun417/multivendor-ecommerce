                ...
                <div class="my-md-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                            ...
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="{{ url('blog-v2') }}">Design</a></li>
                    ...
                    <div class="min-width-1100-wd">
                        ...
                        <div class="bg-gray-1 px-3 py-5 mb-10">
                            ...
                            <div class="d-block d-md-flex media">
                                ...
                                <div class="media-body">
                                    <h3 class="font-size-18 mb-3"><a href="{{ url('single-blog') }}">Jane Smith</a></h3>
                        ...
                        <ul class="nav justify-content-between mb-11">
                            <li class="nav-item m-0">
                                <a class="nav-link text-gray-27 px-0" href="{{ url('single-blog') }}"><span class="mr-1">←</span> SpaceX Falcon explodes after Landing</a>
                            </li>
                            <li class="nav-item m-0">
                                <a class="nav-link text-gray-27 px-0" href="{{ url('single-blog') }}">Announcement – Post without Image <span class="ml-1">→</span></a>
                            </li>
                        </ul>
                        <div class="mb-10">
                                ...
                                <li class="w-100 border-bottom pb-6 mb-6 border-color-1">
                                    ...
                                    <div class="d-block d-md-flex media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="d-flex">
                                                <h4 class="font-size-14 font-weight-bold mr-2"><a href="{{ url('single-blog') }}" class="">John Doe</a></h4>
                                                <span><a href="{{ url('single-blog') }}" class="text-gray-23">March 16, 2016</a></span>
                                ...
                                <li class="w-100 border-bottom pb-6 mb-6 border-color-1">
                                    ...
                                    <div class="d-block d-md-flex media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="d-flex">
                                                <h4 class="font-size-14 font-weight-bold mr-2"><a href="{{ url('single-blog') }}" class="">Anna Kowalsky</a></h4>
                                                <span><a href="{{ url('single-blog') }}" class="text-gray-23">March 16, 2016</a></span>
                                                <a href="#" class="text-blue ml-auto">Reply</a>
                                            </div>
                                        </div>
                                ...
                                <li class="w-100">
                                    ...
                                    <div class="d-block d-md-flex media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="d-flex">
                                                <h4 class="font-size-14 font-weight-bold mr-2"><a href="{{ url('single-blog') }}" class="">Peter Wargner</a></h4>
                                                <span><a href="{{ url('single-blog') }}" class="text-gray-23">March 16, 2016</a></span>
                                                <a href="#" class="text-blue ml-auto">Reply</a>
                                            </div>
                                        </div>
