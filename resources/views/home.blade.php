                                                    ...
                                                    <div
                                                        ...
                                                        <div class="product-item__body pb-xl-2">
                                                            ...
                                                            <div class="mb-2"><a
                                                                    ...
                                                                    class="font-size-12 text-gray-5">{{ $fp->category->name }}</a></div>
                                                            <h5 class="mb-4 product-item__title"><a
                                                                    href="{{ route('product.details', $fp->slug) }}"
                                                                    class="text-blue font-weight-bold">{{ $fp->name }}</a></h5>
                                                            <div class="mb-1">
                                                                <div class="prodcut-price">
                                                                    <div class="text-gray-100">{{ getCurrencyIcon() }} {{ $fp->price }}</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
