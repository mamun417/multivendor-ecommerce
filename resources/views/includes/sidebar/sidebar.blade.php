...
<div class="cat_br_bg">
    <h3 class="cat-title text-truncate">Categories</h3>
    <hr class="hr-mb">
...
<div class="cat_br_bg mt-3 mb-3">
    <h3 class="cat-title text-truncate">Brands</h3>
    <hr class="hr-mb">
    <nav class="sidebar">
        <ul class="brand-area">
            @foreach($brands as $brand)
                <li>
                    <a class="cat_br_hovLink" style="color: #002A5C" href="{{ route('brands.products', $brand->slug) }}">
                        {{ $brand->name }}
                    </a>
                </li>
            @endforeach
