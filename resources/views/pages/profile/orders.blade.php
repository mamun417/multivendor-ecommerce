                    ...
                    @foreach(@$orders as $order)
                        <div class="order-block p-3 shadow mt-4">
                            ...
                            <table class="item">
                                @forelse(@$order->orderDetails as $detail)
                                    <tr class="">
                                        <td width="12%">
                                            ...
                                            >
                                                <img class="img-fluid"
                                                     src="{{ $detail->product ? @$detail->product->images()->first()->url : '' }}"
                                        ...
                                        <td width="40%">
                                            <div>
                                                ...
                                                <div>Category : {{$detail->product ?  @$detail->product->category->name : '' }}</div>
                                                <div>Brand : {{ $detail->product ? @$detail->product->brand->name : '' }}</div>
                                ...
                                @empty
                                    <div class="alert alert-danger mt-5">No records</div>
                                @endforelse
                            </table>
